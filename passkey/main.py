...
class Passkey:
    ...
    def get_passkey(self):
        ...
        'x-tt-passport-csrf-token': self.tokens,
        ...
        try:
            ...
            try:
                ...
                return{"has_email":has_email,"has_mobile":has_mobile,"has_outh":has_outh,"has_plat":platforms,"safe":safe,"mobile":mobile,"email":email,"has_pas":has_pas,"status":"true"}
            except:
                return{"status":"error"}
        except:
            return{"status":"error"}
# print(Passkey("atro@gmail.com").get_passkey())