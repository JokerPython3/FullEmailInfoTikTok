...
import requests, SignerPy, json, secrets, uuid, binascii, os, time, random,uvicorn
...
app = FastAPI()
@app.get("/ntro")
async def atro(email:str) -> Any:
   return Email2UsernameTikTok(email).get_ksj()

if __name__ == "__main__":
    #api_fast => FIle name 
    uvicorn.run("api_fast:app", host="127.0.0.1", port=8000, reload=True)
#http://127.0.0.1:8000/ntro?email=atro@gmail.com
#Ntro